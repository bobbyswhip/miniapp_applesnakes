    ...
    return (
      <div className="h-full flex items-center justify-center bg-[#1a2221]/30 rounded-lg">
        <div className="text-center p-6">
          ...
          <p className="text-[#8a9090] text-sm">Connect your wallet to view rewards</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-full flex items-center justify-center bg-[#1a2221]/30 rounded-lg">
        <div className="text-center">
          ...
          <p className="text-[#8a9090] text-xs">Scanning markets for rewards...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="h-full overflow-y-auto space-y-4 p-2">
      ...
      <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border border-yellow-500/30 rounded-xl p-4">
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-xs text-[#8a9090]">Prediction market winnings & refunds ready to claim</p>
          </div>
          <button
            onClick={() => refetch()}
            className="p-2 bg-[#1f2827]/50 rounded-lg hover:bg-[#2a3533]/50 transition-colors"
            title="Refresh"
          >
        ...
        <div className="grid grid-cols-3 gap-2 mb-3">
          <div className="bg-[#1a2221]/50 rounded-lg p-2 text-center">
            <div className="text-xl font-bold text-yellow-400">{totalClaimableFormatted}</div>
            <div className="text-[10px] text-[#8a9090]">Total Claimable</div>
          </div>
      ...
      {rewards.length === 0 ? (
        <div className="text-center py-8">
          <div className="text-4xl mb-3">🎯</div>
          <p className="text-[#8a9090] text-sm">No unclaimed rewards</p>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-mono text-[#6b7575]">#{reward.marketId}</span>
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-green-500/20 text-green-400">
                        ✓ Won
                      </span>
                      <span className="text-[10px] text-[#6b7575]">
                  ...
                  {reward.winningOutcome > 0 && (
                    <div className="text-[10px] text-[#8a9090] mb-2">
          ...
          {refunds.length > 0 && (
            <div className="space-y-2">
              <div className="flex items-center gap-2 px-1">
                ...
                <span className="text-[10px] text-[#6b7575]">(cancelled markets)</span>
              </div>
              {refunds.map((reward) => (
                <div
                  key={reward.marketId}
      ...
      <div className="h-full overflow-y-auto p-4">
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-500/30 rounded-2xl p-8 text-center">
            ...
            <p className="text-[#cecece] mb-8 text-lg">
            ...
            <div className="bg-[#1a2221]/50 rounded-xl p-6 mb-8 text-left max-w-md mx-auto">
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-[#8a9090]">Token:</span>
                  <span className="text-white font-medium">{newLaunch.name} (${newLaunch.symbol})</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#8a9090]">Duration:</span>
                  <span className="text-[#ffd075] font-medium">{formatDuration(formData.durationHours)}</span>
                </div>
                {newLaunch.targetAmount && (
                  <div className="flex justify-between">
                    <span className="text-[#8a9090]">Target:</span>
            ...
            <div className="bg-[#3d2e1a]/20 border border-[rgba(255,208,117,0.3)] rounded-xl p-4 mb-8 max-w-md mx-auto">
              <p className="text-[#ffe0a0]">
            ...
            <div className="flex gap-4 justify-center">
              <button
                onClick={onSuccess}
                className="px-8 py-3 bg-gradient-to-r from-[#c5a97b] to-[#c5a97b] text-white font-bold rounded-xl hover:from-[#ffd075] hover:to-[#ffd075] transition-all"
              >
                View War
              </button>
              <button
                onClick={resetForm}
                className="px-8 py-3 bg-[#1f2827] text-white font-medium rounded-xl hover:bg-[#2a3533] transition-colors"
              >
                Create Another
              </button>
            </div>
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <p className="text-[#8a9090]">Connect your wallet to create a Token War</p>
        </div>
      </div>
    );
  }
    ...
    <div className="h-full overflow-y-auto p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-[#8a9090]">Launch a 24-hour token war and let the community decide</p>
        </div>

        {/* Progress indicator */}
        {isLoading && (
          <div className="mb-6 p-4 bg-[#3d2e1a]/30 rounded-xl border border-[rgba(255,208,117,0.3)]">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-6 h-6 border-2 border-[#c5a97b] border-t-transparent rounded-full animate-spin" />
              <span className="text-white font-medium">{progress.message}</span>
            </div>
            <div className="h-2 bg-[#1f2827] rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-[#c5a97b] to-[#c5a97b] transition-all duration-300"
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-5">
              <div className="bg-[#1a2221]/30 rounded-xl p-5 border border-[rgba(255,255,255,0.04)]">
                ...
                {/* Token Name */}
                <div className="mb-4">
                  <label className="block text-sm font-medium text-[#cecece] mb-2">Token Name *</label>
                  <input
                    type="text"
                    value={formData.name}
                    ...
                    required
                    disabled={isLoading}
                    className="w-full bg-[#171e1d]/50 border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#c5a97b] disabled:opacity-50"
                  />
                </div>

                {/* Symbol */}
                <div className="mb-4">
                  <label className="block text-sm font-medium text-[#cecece] mb-2">Symbol *</label>
                  <input
                    type="text"
                ...
                {/* Description */}
                <div className="mb-4">
                  <label className="block text-sm font-medium text-[#cecece] mb-2">Description</label>
                  <textarea
                    ...
                    rows={4}
                    disabled={isLoading}
                    className="w-full bg-[#171e1d]/50 border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#c5a97b] disabled:opacity-50 resize-none"
                  />
                </div>

                {/* Image Upload */}
                <div>
                  <label className="block text-sm font-medium text-[#cecece] mb-2">Token Image</label>
                  <div className="flex items-center gap-4">
                    {imagePreview ? (
                      <img src={imagePreview} alt="Preview" className="w-20 h-20 rounded-full object-cover border-2 border-[#c5a97b]" />
                    ) : (
                      <div className="w-20 h-20 rounded-full bg-[#1f2827] flex items-center justify-center text-[#8a9090] text-2xl">
                        📷
                      </div>
                    )}
                    <label className="flex-1 cursor-pointer">
                      <div className="bg-[#171e1d]/50 border border-[rgba(255,255,255,0.1)] border-dashed rounded-lg px-4 py-4 text-center text-[#8a9090] hover:border-[#c5a97b] transition-colors">
              ...
              <div className="bg-[#1a2221]/30 rounded-xl p-5 border border-[rgba(255,255,255,0.04)]">
                ...
                {/* Target Amount */}
                <div className="mb-4">
                  <label className="block text-sm font-medium text-[#cecece] mb-2">Target Amount (USDC)</label>
                  <input
                    type="number"
                    ...
                    className="w-full bg-[#171e1d]/50 border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#c5a97b] disabled:opacity-50"
                  />
                  <p className="text-xs text-[#6b7575] mt-1">Optional funding goal</p>
                </div>

                {/* Initial Contribution */}
                <div>
                  <label className="block text-sm font-medium text-[#cecece] mb-2">Your Initial Contribution (USDC) *</label>
                  <input
                    type="number"
                    ...
                    className="w-full bg-[#171e1d]/50 border border-[rgba(255,255,255,0.1)] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#c5a97b] disabled:opacity-50"
                  />
                  <p className="text-xs text-[#6b7575] mt-1">Minimum $5. No decimals allowed.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[#1a2221]/30 rounded-xl p-5 border border-[rgba(255,255,255,0.04)]">
                ...
                {/* DEX Vote */}
                <div className="mb-5">
                  <label className="block text-sm font-medium text-[#cecece] mb-3">DEX Vote</label>
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border-2 text-center transition-all ${
                          formData.dexVote === dex
                            ? dex === 'v4' ? 'bg-[#c5a97b]/20 border-[#c5a97b] text-[#ffd075]'
                            : dex === 'aerodrome' ? 'bg-[#c5a97b]/20 border-[#c5a97b] text-[#ffd075]'
                            : 'bg-orange-500/20 border-orange-500 text-orange-400'
                            : 'border-[rgba(255,255,255,0.1)] text-[#8a9090] hover:border-[rgba(255,255,255,0.15)]'
                        }`}
                      >
                ...
                {/* Pair Vote */}
                <div>
                  <label className="block text-sm font-medium text-[#cecece] mb-3">Pair Vote</label>
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-3 p-4 rounded-xl border-2 transition-all ${
                        formData.pairVote === 'eth'
                          ? 'bg-[#c5a97b]/20 border-[#c5a97b] text-[#ffd075]'
                          : 'border-[rgba(255,255,255,0.1)] text-[#8a9090] hover:border-[rgba(255,255,255,0.15)]'
                      }`}
                    >
              ...
              <div className="bg-[#1a2221]/30 rounded-xl p-5 border border-[rgba(255,255,255,0.04)]">
                ...
                <p className="text-sm text-[#8a9090] mb-4">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                        formData.durationHours === hours
                          ? 'bg-[#c5a97b]/30 border-2 border-[#c5a97b] text-[#ffd075]'
                          : 'bg-[#1f2827]/50 border-2 border-transparent text-[#8a9090] hover:border-[rgba(255,255,255,0.15)]'
                      }`}
                    >
                      {label}
                    </button>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-4">
                    <input
                      ...
                      disabled={isLoading}
                      className="flex-1 h-2 bg-[#1f2827] rounded-lg appearance-none cursor-pointer accent-[#c5a97b]"
                    />
                    <span className="text-[#ffd075] font-bold min-w-[80px] text-right">
                ...
                {/* End time preview */}
                <div className="mt-4 p-3 bg-[#171e1d]/50 rounded-lg">
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-[#8a9090]">War ends:</span>
              ...
              <div className="bg-[#1a2221]/30 rounded-xl p-5 border border-[rgba(255,255,255,0.04)]">
                <h3 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
                  ...
                  <span className="text-[10px] px-2 py-0.5 bg-[#c5a97b]/20 text-[#ffd075] rounded-full">Advanced</span>
                </h3>
                <p className="text-sm text-[#8a9090] mb-4">
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-4 p-3 bg-[#171e1d]/30 rounded-lg cursor-pointer hover:bg-[#171e1d]/50 transition-colors">
                    <input
                      type="checkbox"
                      checked={formData.lockDex}
                      onChange={(e) => setFormData(prev => ({ ...prev, lockDex: e.target.checked }))}
                      disabled={isLoading}
                      className="w-5 h-5 rounded border-[rgba(255,255,255,0.1)] bg-[#1f2827] text-[#c5a97b] focus:ring-[#c5a97b]"
                    />
                    <div className="flex-1">
                      <span className="text-white font-medium">Lock DEX to {formData.dexVote === 'v4' ? 'Uniswap V4' : formData.dexVote}</span>
                      <p className="text-xs text-[#6b7575]">Disable DEX voting - all buys use your choice</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-4 p-3 bg-[#171e1d]/30 rounded-lg cursor-pointer hover:bg-[#171e1d]/50 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-[#6b7575]">Disable pair voting - all buys use your choice</p>
                    </div>
                  </label>
                </div>
              ...
              {/* Info Box */}
              <div className="bg-[#3d2e1a]/20 border border-[rgba(255,208,117,0.3)] rounded-xl p-4">
                <div className="flex items-start gap-3">
                  <span className="text-2xl">ℹ️</span>
                  <div className="text-sm text-[#cecece]">
              ...
              <button
                ...
                className={`
                  ...
                  ${isLoading || !walletAddress || usdcAmount < 5
                    ...
                    : 'bg-gradient-to-r from-[#c5a97b] to-[#c5a97b] text-white hover:from-[#ffd075] hover:to-[#ffd075] hover:scale-[1.02]'
                  }
                `}
              >
                {isLoading ? (
...
export function TokenWars({ onTradeToken }: TokenWarsProps = {}) {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        <div className="w-10 h-10 border-4 border-[rgba(255,208,117,0.3)] border-t-[#c5a97b] rounded-full animate-spin mb-4" />
        <p className="text-[#8a9090]">Loading Token Wars...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Tab Navigation */}
      <div className="flex-shrink-0 flex items-center gap-1 mb-3 border-b border-[rgba(255,255,255,0.04)] pb-2">
        <button
          onClick={() => setActiveTab('wars')}
          className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
            activeTab === 'wars'
              ? 'bg-[#a88a5a] text-white'
              : 'bg-[#1a2221]/50 text-[#8a9090] hover:text-white hover:bg-[#1f2827]/50'
          }`}
        >
          Active Wars
        </button>
        ...
        {address && (
          <button
            ...
            className={`ml-auto px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
              activeTab === 'create'
                ? 'bg-gradient-to-r from-[#c5a97b] to-[#c5a97b] text-white'
                : 'bg-gradient-to-r from-[#c5a97b]/50 to-[#c5a97b]/50 text-white/80 hover:from-[#c5a97b] hover:to-[#c5a97b] hover:text-white'
            }`}
          >
            + Create
          </button>
        ...
        {activeTab === 'wars' && (
          <div className="h-full overflow-y-auto space-y-4">
            ...
            <div className="flex items-center gap-1 text-xs overflow-x-auto pb-1">
              <div className="flex items-center gap-1 px-2 py-1 bg-[#1a2221]/50 rounded-lg whitespace-nowrap">
                <span className="text-[#8a9090]">Active:</span>
                <span className="font-bold text-white">{stats.activeLaunches}</span>
              </div>
              <div className="flex items-center gap-1 px-2 py-1 bg-[#1a2221]/50 rounded-lg whitespace-nowrap">
                <span className="text-[#8a9090]">Raised:</span>
                <span className="font-bold text-green-400">${stats.totalRaisedUsdc.toLocaleString()}</span>
              </div>
              <div className="flex items-center gap-1 px-2 py-1 bg-[#1a2221]/50 rounded-lg whitespace-nowrap">
                <span className="text-[#8a9090]">Markets:</span>
                <span className="font-bold text-[#ffd075]">{stats.activePredictionMarkets}</span>
              </div>
              <div className="flex items-center gap-1 px-2 py-1 bg-[#1a2221]/50 rounded-lg whitespace-nowrap">
                <span className="text-[#8a9090]">Users:</span>
                <span className="font-bold text-[#ffd075]">{stats.totalParticipants}</span>
              </div>
            </div>
...
function StatCard({ label, value, icon }: { label: string; value: string | number; icon: string }) {
  return (
    <div className="bg-[#1a2221]/50 rounded-xl p-3 border border-[rgba(255,255,255,0.04)]">
      <div className="flex items-center gap-2 mb-1">
        <span className="text-lg" dangerouslySetInnerHTML={{ __html: icon }} />
        <span className="text-[#8a9090] text-xs">{label}</span>
      </div>
...
function EmptyState({ type }: { type: 'launches' | 'markets' }) {
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#c5a97b]/20 to-[#c5a97b]/20 flex items-center justify-center border border-[rgba(255,208,117,0.3)] mb-4">
        <span className="text-4xl">⚔️</span>
      </div>
      <h3 className="text-xl font-bold text-white mb-2">No Active Wars</h3>
      <p className="text-[#8a9090] max-w-sm">
...
function LaunchCard({
  ...
  return (
    <div
      className={`
        bg-[#1a2221]/50 rounded-xl p-4 border-2 transition-all duration-200
        ${isEnded ? 'opacity-60' : ''}
        ${isEnding && !isEnded ? 'border-orange-500/50' : 'border-[rgba(255,255,255,0.04)]'}
      `}
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          {launch.imageUrl ? (
            ...
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#c5a97b] to-[#c5a97b] flex items-center justify-center text-lg font-bold text-white">
              {launch.symbol.slice(0, 2)}
            </div>
          )}
          <div>
            <h3 className="font-bold text-white">{launch.name}</h3>
            <span className="text-sm text-[#8a9090]">${launch.symbol}</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          {/* RAW ICO Badge */}
          {launch.locks?.isRawIco && (
            <span className="px-2 py-1 bg-[#a88a5a]/30 text-[#ffe0a0] text-xs rounded-full font-medium border border-[rgba(255,208,117,0.3)]">
              RAW ICO
            </span>
          )}
          {hasMarket && (
            <span className="px-2 py-1 bg-[#c5a97b]/20 text-[#ffd075] text-xs rounded-full font-medium">
              🔮
            </span>
          )}
      ...
      {launch.targetAmount && (
        <div className="mb-3">
          ...
          <div className="h-2 bg-[#1f2827] rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#c5a97b] to-[#c5a97b] transition-all duration-500"
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        <div className="bg-[#171e1d]/50 rounded-lg p-2 text-center">
          <div className="text-[#8a9090] text-xs">Raised</div>
          <div className="font-bold text-green-400">${launch.totalRaised.toLocaleString()}</div>
        </div>
        <div className="bg-[#171e1d]/50 rounded-lg p-2 text-center">
          <div className="text-[#8a9090] text-xs">Participants</div>
      ...
      {launch.predictionMarket?.hasMarket && (
        <div className="grid grid-cols-3 gap-2 mb-3">
          <div className="bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg p-2 text-center">
            <div className="text-[#ffd075]/70 text-xs">💵 Pool</div>
            <div className="font-bold text-[#ffd075] text-sm">${(launch.predictionMarket.totalPool || 0).toLocaleString()}</div>
          </div>
          <div className="bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg p-2 text-center">
            <div className="text-[#ffd075]/70 text-xs">🎲 Bets</div>
            <div className="font-bold text-[#ffd075] text-sm">{launch.predictionMarket.totalBets || 0}</div>
          </div>
          <div className="bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg p-2 text-center">
            <div className="text-[#ffd075]/70 text-xs">👥 Bettors</div>
            <div className="font-bold text-[#ffd075] text-sm">{launch.predictionMarket.uniqueBettors || 0}</div>
          </div>
        </div>
      )}

      {/* Countdown */}
      <div className={`text-center py-2 rounded-lg ${isEnding && !isEnded ? 'bg-orange-500/20' : 'bg-[#171e1d]/50'}`}>
        <div className="text-xs text-[#8a9090] mb-1">
      ...
      {!isEnded && (
        <div className="flex gap-2 mt-3">
          <button
            onClick={onClick}
            className="flex-1 py-2 rounded-lg font-medium transition-colors bg-gradient-to-r from-[#c5a97b] to-[#c5a97b] text-white hover:from-[#ffd075] hover:to-[#ffd075]"
          >
            Join War
          </button>
          {onMarketClick && (
            <button
              ...
              className="px-4 py-2 rounded-lg font-medium transition-colors bg-[#3d2e1a]/50 text-[#ffd075] hover:bg-[#3d2e1a]/70 border border-[rgba(255,208,117,0.3)]"
            >
              🔮 Predict
            </button>
          )}
...
function WarDetailView({
  ...
  if (fetchingDetails) {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        <div className="w-10 h-10 border-4 border-[rgba(255,208,117,0.3)] border-t-[#c5a97b] rounded-full animate-spin mb-4" />
        <p className="text-[#8a9090]">Loading war details...</p>
      </div>
    );
  }
  ...
  if (!launch) {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        <p className="text-[#8a9090] mb-4">War not found</p>
        <button
          onClick={onClose}
          className="px-4 py-2 bg-[#1f2827] text-white rounded-lg hover:bg-[#2a3533] transition-colors"
        >
          ← Back to Wars
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-shrink-0 pb-2 border-b border-[rgba(255,255,255,0.04)] mb-2">
        {/* Top Row: Back + Token Info + Timer */}
        <div className="flex items-center gap-1 sm:gap-2 mb-2">
          <button
            onClick={onClose}
            className="p-1 sm:p-1.5 hover:bg-[#1a2221] rounded-lg transition-colors text-[#8a9090] hover:text-white flex-shrink-0"
          >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-1 min-w-0">
            {launch.imageUrl ? (
              ...
              <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-[#c5a97b] to-[#c5a97b] flex items-center justify-center text-xs sm:text-sm font-bold text-white flex-shrink-0">
                {launch.symbol.slice(0, 2)}
              </div>
            )}
            <div className="min-w-0 flex-1">
              <h1 className="text-sm sm:text-base font-bold text-white truncate">{launch.name}</h1>
              <span className="text-[10px] sm:text-xs text-[#8a9090]">${launch.symbol}</span>
            </div>
          </div>
          <div className={`text-right px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-lg flex-shrink-0 ${isEnding && !isEnded ? 'bg-orange-500/20' : 'bg-[#1a2221]/50'}`}>
            <div className="text-[8px] sm:text-[10px] text-[#8a9090]">{isEnded ? 'Ended' : 'Time Left'}</div>
            <div className={`text-xs sm:text-sm font-mono font-bold ${isEnding && !isEnded ? 'text-orange-400' : 'text-[#ffd075]'}`}>
              {formatTime(timeRemaining)}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-xs overflow-x-auto pb-2 scrollbar-hide">
          ...
          <div className="flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[#1a2221]/50 rounded-lg whitespace-nowrap">
            <span className="text-[#8a9090] text-[10px] sm:text-xs">👥</span>
            <span className="font-bold text-white">{launch.participantCount}</span>
          </div>
          <div className="flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg whitespace-nowrap">
            <span className="text-[#ffd075]/70 text-[10px] sm:text-xs">📊</span>
            <span className="font-bold text-[#ffd075]">{walletInfo?.sharePercent?.toFixed(1) || '0'}%</span>
          </div>
          {/* Separator */}
          <div className="w-px h-3 sm:h-4 bg-[#2a3533] mx-0.5 sm:mx-1 flex-shrink-0"></div>
          {/* Prediction Stats */}
          <div className="flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg whitespace-nowrap">
            <span className="text-[#ffd075]/70 text-[10px] sm:text-xs">🎲</span>
            <span className="font-bold text-[#ffd075]">
              {totalMarkets > 0 ? (
          ...
          {totalPredictionPool > 0 && (
            <div className="flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg whitespace-nowrap">
              <span className="text-[#ffd075]/70 text-[10px] sm:text-xs">🎲</span>
              <span className="font-bold text-[#ffd075]">{totalPredictionPool.toFixed(2)} wASS</span>
            </div>
          )}
          {totalUserPositions > 0 && (
            <div className="flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.2)] rounded-lg whitespace-nowrap">
              <span className="text-[#ffd075]/70 text-[10px] sm:text-xs">📈</span>
              <span className="font-bold text-[#ffd075]">{totalUserPositions}</span>
            </div>
          )}
          {totalClaimable > 0 && (
        ...
        <div className="mt-2 mb-1">
          <div className="flex justify-between text-[10px] mb-1">
            <span className="text-[#8a9090]">ICO Progress</span>
            <span className="text-white">
              ${launch.totalRaised.toLocaleString()}
              {launch.targetAmount ? ` / $${launch.targetAmount.toLocaleString()}` : ''}
            </span>
          </div>
          <div className="h-2 bg-[#1f2827]/50 rounded-full overflow-hidden">
            <div
          ...
          {launch.targetAmount && (
            <div className="text-right text-[9px] text-[#6b7575] mt-0.5">
          ...
          <button
            ...
            className={`flex-1 py-1.5 sm:py-2 px-2 sm:px-3 rounded-lg font-bold text-xs sm:text-sm transition-all ${
              activeTab === 'ico'
                ...
                : 'bg-[#1a2221]/50 text-[#8a9090] hover:bg-[#1f2827]/50 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-1.5 sm:py-2 px-2 sm:px-3 rounded-lg font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-1 sm:gap-2 ${
              activeTab === 'predictions'
                ? 'bg-gradient-to-r from-[#a88a5a] to-[#a88a5a] text-white shadow-lg shadow-[rgba(255,208,117,0.2)]'
                : 'bg-[#1a2221]/50 text-[#8a9090] hover:bg-[#1f2827]/50 hover:text-white'
            }`}
          >
            ...
            {predictionMarkets.length > 0 && (
              <span className={`px-1 sm:px-1.5 py-0.5 rounded text-[9px] sm:text-[10px] ${
                activeTab === 'predictions' ? 'bg-white/20' : 'bg-[#c5a97b]/30 text-[#ffd075]'
              }`}>
      ...
      {(launch.locks?.isRawIco || launch.locks?.lockedDex || launch.locks?.lockedPair) && (
        <div className="flex-shrink-0 mb-2 p-2 bg-[#3d2e1a]/30 border border-[rgba(255,208,117,0.3)] rounded-lg">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-sm">🔒</span>
            <span className="text-xs font-bold text-[#ffd075]">RAW ICO MODE</span>
          </div>
          <div className="text-[10px] text-[#ffe0a0]/80 space-y-0.5">
            ...
            <p className="text-[#ffd075]/60">Voting disabled for locked options • 15% protocol fee</p>
          </div>
        </div>
      )}
      ...
      {(selloutNotification || (consensus && (consensus.dex?.isTie || consensus.pair?.isTie))) && (
        <div className="flex-shrink-0 space-y-1 mb-2">
          ...
          {consensus?.pair?.isTie && (
            <div className="flex items-center gap-2 px-2 py-1.5 bg-[#3d2e1a]/30 rounded-lg text-xs text-[#ffd075]">
      ...
      {launch.tokenAddress && (
        <div className="flex-shrink-0 bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-500/30 rounded-lg p-2 mb-2">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="text-xs text-[#8a9090]">Token:</span>
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 gap-2 overflow-hidden">
        ...
        <div className="flex flex-col min-h-0 overflow-hidden">
          {!isEnded ? (
            <div className="flex-1 bg-[#1a2221]/50 rounded-lg p-2 border border-[rgba(255,255,255,0.04)] overflow-y-auto">
              ...
              {/* DEX Vote - Compact */}
              <div className="mb-2">
                <label className="block text-[10px] font-medium text-[#8a9090] mb-1">DEX Vote</label>
                {/* Check if DEX is locked (RAW ICO mode) - check both isDexLocked and lockedDex directly */}
                {(launch.locks?.isDexLocked || launch.locks?.lockedDex) ? (
                  <div className="bg-[#171e1d]/50 rounded-lg p-2 border border-[rgba(255,208,117,0.3)]">
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-[#8a9090]">🔒 Locked to:</span>
                      <span className="text-xs font-bold text-[#ffd075] uppercase">
                        {launch.locks?.lockedDex === 'v4' ? 'Uniswap V4' : launch.locks?.lockedDex}
                      </span>
                    </div>
                    <p className="text-[9px] text-[#6b7575] mt-1">Voting disabled by creator (RAW ICO)</p>
                  </div>
                ) : (
                      ...
                      return (
                        <button
                          ...
                          className={`p-1 sm:p-1.5 rounded-lg border text-center transition-all ${
                            protocolVote === dex
                              ? dex === 'uniswap' ? 'bg-[#c5a97b]/20 border-[#c5a97b] text-[#ffd075]'
                              : dex === 'aerodrome' ? 'bg-[#c5a97b]/20 border-[#c5a97b] text-[#ffd075]'
                              : 'bg-orange-500/20 border-orange-500 text-orange-400'
                              : 'border-[rgba(255,255,255,0.1)] text-[#8a9090] hover:border-[rgba(255,255,255,0.15)]'
              ...
              {/* Pair Vote - Compact */}
              <div className="mb-2">
                <label className="block text-[10px] font-medium text-[#8a9090] mb-1">Pair Vote</label>
                  ...
                  <div className="grid grid-cols-2 gap-0.5 sm:gap-1">
                    <button
                      ...
                      className={`flex items-center gap-1 sm:gap-1.5 p-1 sm:p-1.5 rounded-lg border transition-all ${
                        pairVote === 'eth' ? 'bg-[#c5a97b]/20 border-[#c5a97b]' : 'border-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.15)]'
                      } ${buyLoading ? 'opacity-50' : ''}`}
                    >
                      <img src="/Images/Ether.png" alt="ETH" className="w-4 h-4 sm:w-5 sm:h-5" />
                      <div className="text-left min-w-0">
                        <div className={`text-[10px] sm:text-xs font-bold ${pairVote === 'eth' ? 'text-[#ffd075]' : 'text-white'}`}>ETH</div>
                        <div className="text-[8px] sm:text-[9px] text-[#8a9090]">${consensus?.pair?.eth?.votes ?? 0} ({(consensus?.pair?.eth?.percent ?? 50).toFixed(0)}%)</div>
                      </div>
                    </button>
                    <button
                      ...
                      disabled={buyLoading}
                      className={`flex items-center gap-1 sm:gap-1.5 p-1 sm:p-1.5 rounded-lg border transition-all ${
                        pairVote === 'wass' ? 'bg-green-500/20 border-green-500' : 'border-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.15)]'
                      } ${buyLoading ? 'opacity-50' : ''}`}
                    >
                      ...
                      <div className="text-left min-w-0">
                        ...
                        <div className="text-[8px] sm:text-[9px] text-[#8a9090]">${consensus?.pair?.wass?.votes ?? 0} ({(consensus?.pair?.wass?.percent ?? 50).toFixed(0)}%)</div>
                      </div>
                    </button>
                  </div>
                )}
              ...
              <div className="mb-2">
                <label className="block text-[9px] sm:text-[10px] font-medium text-[#8a9090] mb-1">Amount (USDC)</label>
                <div className="relative mb-1">
                  <span className="absolute left-2 top-1/2 -translate-y-1/2 text-[#8a9090] text-xs sm:text-sm">$</span>
                  <input
                    type="number"
                    value={amount}
                    onChange={(e) => {
                    ...
                    className="w-full bg-[#171e1d] border border-[rgba(255,255,255,0.06)] rounded-lg pl-5 sm:pl-6 pr-2 py-1.5 sm:py-2 text-sm sm:text-base text-white focus:outline-none focus:border-[#c5a97b]"
                    min="1"
                    step="1"
                  />
                </div>
                  ...
                  {[5, 10, 25, 50, 100, 500].map((val) => (
                    <button
                      ...
                      className={`py-1 sm:py-1.5 rounded text-[9px] sm:text-[10px] font-medium transition-colors ${
                        amount === val.toString() ? 'bg-[#a88a5a] text-white' : 'bg-[#1f2827] text-[#cecece] hover:bg-[#2a3533]'
                      }`}
                    >
                      ${val}
                    </button>
              ...
              {/* Estimated Share */}
              <div className="flex justify-between items-center text-[10px] sm:text-xs bg-[#171e1d]/50 rounded-lg px-2 py-1 sm:py-1.5 mb-2">
                <span className="text-[#8a9090]">Est. Share:</span>
                ...
                className={`w-full py-2 sm:py-2.5 rounded-lg font-bold text-xs sm:text-sm transition-all ${
                  buyLoading || !walletAddress
                    ...
                    : protocolVote === 'uniswap'
                      ? 'bg-gradient-to-r from-[#a88a5a] to-[#c5a97b] text-white hover:from-[#c5a97b] hover:to-[#ffd075]'
            ...
            <div className="flex-1 bg-[#1a2221]/50 rounded-lg p-3 border border-[rgba(255,255,255,0.04)] flex items-center justify-center">
              <div className="text-center text-[#8a9090]">
        ...
        <div className="flex flex-col min-h-0 gap-1.5 sm:gap-2 overflow-hidden">
          {/* Consensus - Compact */}
          <div className="flex-shrink-0 bg-[#1a2221]/50 rounded-lg p-1.5 sm:p-2 border border-[rgba(255,255,255,0.04)]">
          ...
          <div className="flex-1 min-h-0 bg-[#1a2221]/50 rounded-lg p-1.5 sm:p-2 border border-[rgba(255,255,255,0.04)] flex flex-col overflow-hidden">
              ...
              {topContributors.length > 0 ? (
                <div className="space-y-0.5 sm:space-y-1">
                  {topContributors.slice(0, 8).map((p: TopContributor) => (
                    <div key={p.fullWallet} className="flex justify-between items-center p-1 sm:p-1.5 bg-[#171e1d]/50 rounded-lg">
                      <div className="flex items-center gap-1 sm:gap-1.5 min-w-0">
                        <span className={`text-[10px] sm:text-xs font-bold flex-shrink-0 ${
                          p.rank === 1 ? 'text-yellow-400' : p.rank === 2 ? 'text-[#cecece]' : p.rank === 3 ? 'text-orange-400' : 'text-[#6b7575]'
                        }`}>
                      ...
                      <div className="text-right flex-shrink-0">
                        ...
                        <div className="text-[8px] sm:text-[10px] text-[#ffd075]">{p.sharePercent.toFixed(1)}%</div>
                      </div>
                    </div>
                  ))}
                </div>
              ) : (
                <div className="text-center py-3 sm:py-4 text-[#8a9090] text-[10px] sm:text-xs">
